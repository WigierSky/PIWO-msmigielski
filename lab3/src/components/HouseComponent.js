    ...
    <article type="card" className="house-card">
      ...
      <div className="house-info">
        <div className="house-details">
          ...
          <p className="bedroom-info">{props.house.bedsCount} Bedrooms</p>
        </div>
        <div className="house-description">
          <h1 className="house-address">{props.house.address}</h1>
          <p>{props.house.description}</p>
        </div>
        <div className="house-footer">
          <p className="house-price">$ {props.house.price}</p>
        </div>
      </div>
    </article>
  );
